...
(defconst elemental-faces-list
  (mapcar
   ...
   '(;; ----- special faces -----
     ...
     (font-lock-regexp-grouping-backslash :inherit elemental-orange-face)
     (font-lock-regexp-grouping-construct :inherit elemental-orange-face)
     ...
     (web-mode-html-tag-bracket-face :inherit outline-1)
